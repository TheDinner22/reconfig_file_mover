...
// Board class
// This class implements a number of methods for interfacing with the FPGA. For the ZedBoard, this "board" is
// just the programmable logic section, but the class maintains the board analogy for use with other FPGAs
// that are on a separate board.
...
// total size in words of memory-map address space
